...
class StudentOnlySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $studentsData = [
            [
                ...
                'email' => 'rahul.sharma2@example.com',
                'mobile' => '9876543210',
            ...
            [
                ...
                'email' => 'vikram.shah2@example.com',
                'mobile' => '5432109876',
        ...
        foreach ($studentsData as $index => $studentData) {
            try {
                ...
                // Store course-specific enrollment details in the student_courses pivot table.
                $student->courses()->attach($course->id, [
                    'enrollment_date' => $studentData['enrollment_date'],
                    'course_taken' => $course->name,
                    'batch_time' => $studentData['batch_time'] ?? null,
                    'scheme_given' => $studentData['scheme_given'] ?? null,
                    'incharge_name' => $studentData['incharge_name'] ?? null,
                ]);
