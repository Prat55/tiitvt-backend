...
class DocumentApiController extends Controller
{
    ...
    public function installmentReceipt(Request $request, Installment $installment)
    {
        ...
        $pdf = Pdf::loadView('receipt.computer_invoice_pdf', $this->buildInstallmentReceiptData($student, $installment))
    ...
    public function downPaymentReceipt(Request $request, Student $student)
    {
        ...
        $pdf = Pdf::loadView('receipt.computer_invoice_pdf', $this->buildDownPaymentReceiptData($student))
            ->setPaper('a4', 'portrait');
    ...
    private function buildInstallmentReceiptData(Student $student, Installment $installment): array
    {
        ...
        return [
            ...
            'chequeNumber' => null,
            'withdrawnDate' => null,
            'computerGenerated' => true, // Only for API-based installment
        ];
    }
